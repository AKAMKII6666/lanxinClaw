...
export type BridgeUiAction =
  ...
  | { type: "affair.accept"; affairId: string; expectedCurrentJobId: string; acceptanceSummary: string }
...
export type {
  ...
  SnapshotSideChannelMessageView,
  SnapshotSideChannelAttachView,
  SnapshotSideChannelView
